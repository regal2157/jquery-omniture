...
module("view");
test("should throw an error if route is not a string", function() {
  thrower = function() {
    console.log('test');
    throw new Error("invalid 'pattern': this argument must be a string");
  }
	
  raises(thrower, "invalid 'pattern': this argument must be a string", "throws invalid string");
});
